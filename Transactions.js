...
var debugnict = require('debug')('JsSIP:NonInviteClientTransaction', true);
var debugict = require('debug')('JsSIP:InviteClientTransaction', true);
var debugact = require('debug')('JsSIP:AckClientTransaction', true);
var debugnist = require('debug')('JsSIP:NonInviteServerTransaction', true);
var debugist = require('debug')('JsSIP:InviteServerTransaction', true);
