...
function setPeerConnection() {
	...
	console.log(this.pcConstraints)
	console.log(this.pcConfig)
	if (!this.pcConstraints) {
		this.pc = new Adapter.RTCPeerConnection({"iceServers": [{"url": "stun:stun.l.google.com:19302"}]});
	} else {
		// NOTE: Deprecated.
		this.pc = new Adapter.RTCPeerConnection({"iceServers": [{"url": "stun:stun.l.google.com:19302"}]}, this.pcConstraints);
	}
